          ...
          <div className="flex flex-col xs:flex-row justify-between items-center">
            ...
            <div className="text-center">
              <ActiveLink href="/wishlist">
                <a className="font-medium sm:mr-8 mr-1 text-gray-500 hover:text-gray-900">Wishlist</a>
              </ActiveLink>

              {/* Сложная конструкция с тернарными операторами, определяющая наличие Метамаск в барузере, статус загрзки провайдера, аккаунта.
              И исходя из этого показываем надписи: Loading, Hi there, Connect Wallet, Install Metamask  */}
              {isLoading ? (
